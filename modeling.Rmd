...
gn_temp_train <- read.csv("./data/adult_catch_data.csv") %>%
  mutate(BACI = as.factor(BACI),
         ...
         log_cpue = log(cpue+.01), 
         three_year_secchi = (median_secchi + median_secchi_previous+ median_secchi_previous_2)/3)
...
#partialPlot(mixed.rf.gn$forest, independent.gn, BACI)
#partialPlot(mixed.rf.gn$forest, independent.gn, cpue_yep)
#partialPlot(mixed.rf.gn$forest, independent.gn, median_secchi)
