...
gn_temp_train <- gn_temp_train %>% 
  dplyr::filter(!lake_id %in% c(11031200, 11029500, 11082600, 16029700, 16004900, 16008700, 
                                16033600, 29012700, 29023700, 3017700, 16002400, 16003100, 16008500,
                                16023400, 16052900, 16058300, 16063400, 38002000, 38006500, 38044000, 
                                38073700, 69129500, 69006400, 38068800, 38061500, 38040900, 31044400, 
                                16062700, 16045000, 16022500, 16019200, 16015000, 16001500, 15012700, 
                                15009000))
